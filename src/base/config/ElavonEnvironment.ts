 ...
 */
export class ElavonEnvironment {
    ...
    static initServer(merchantId: string, merchantUserId: string, merchantPIN: string, vendorId: string, useSandBox = true, extras = {}) {
        ...
        if (useSandBox) {
            ElavonEnvironment.authUrl = Endpoints.Base.Auth.SANDBOX_URL;
            ElavonEnvironment.baseUrl = Endpoints.Base.Api.SANDBOX_URL;
            ElavonEnvironment.environment = "sandbox";
        } else {
            ElavonEnvironment.authUrl = Endpoints.Base.Auth.PRODUCTION_URL;
            ElavonEnvironment.baseUrl = Endpoints.Base.Api.PRODUCTION_URL;
